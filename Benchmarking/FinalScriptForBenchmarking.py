...
#IMPORTING THE RESULTS FROM RESULT FILE.MAT (from uNIT Paper)

from scipy.io import loadmat
x = loadmat('resultfile.mat') #GET RELEVANT DATA-LIKE SPIKE LABELS, TIME STAMPS FROM THE RESULT FILE
...
x2 = loadmat('script(2)_idxs.mat') #SINCE FILES WERE HUGE, THE ARRAY CONTAINING THE SPIKE FEATURES AND TIMES AND LABELS WERE SPLIT ACROSS 3 FILES AND CONCATENATED LATER
labels2=x2['idx']
